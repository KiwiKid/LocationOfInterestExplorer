   ...
   //   nodeRef={drawerRef}
      ...
      <div className="w-full z-4000 fixed bg-gray-100 h-max rounded-t-3xl border-t-8 border-gray-600">
        ...
        {!pageState.screenshotMode ? <div className="w-full text-center">            
          ...
          <div className="w-full text-center"><div className="text-lg">NiceFullAlwaysNZDate3:<NiceFullAlwaysNZDate3 date={publishState.publishTime}/><br/>NiceFullAlwaysNZDate2:<NiceFullAlwaysNZDate2 date={publishState.publishTime}/></div>
