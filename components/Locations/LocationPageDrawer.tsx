   ...
   //   nodeRef={drawerRef}
      ...
      <div className="w-full z-4000 fixed bg-gray-100 h-max rounded-t-3xl border-t-8 border-gray-600">
        ...
        {!pageState.screenshotMode ? <div className="w-full text-center">            
          ...
          <div className="w-full text-center"><div className="text-2xl"><NiceFullAlwaysNZDate3 date={publishState.publishTime}/><NiceFullAlwaysNZDate2 date={publishState.publishTime}/></div>
