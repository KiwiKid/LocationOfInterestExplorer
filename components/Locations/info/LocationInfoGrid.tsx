...
import { getPresetLocationPrimaryCity, getPrintableLocationOfInterestGroupString, getPrintableLocationOfInterestString, metaImageURL, metaImageURLDirect } from "../LocationObjectHandling";
...
const LocationInfoGrid = ({locations, hardcodedURL, publishTime}:LocationInfoGridProps) => {
    ...
    return (<div className="">
                ...
                .map((groupKey) => <LocationInfoGroup publishTime={publishTime} presetLocations={PRESET_LOCATIONS} key={groupKey.key} groupKey={groupKey} group={groupedLocations[groupKey.key]} hardcodedURL={hardcodedURL}/>)}
            </div>)
}
